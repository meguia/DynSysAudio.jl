...
# ╔═╡ 4a45cd72-1576-11ee-1296-47a459b7c80a
using DifferentialEquations, Plots, PlutoUI, Unitful, SampledSignals, DSP, PortAudio

# ╔═╡ d6f7bf79-e759-4d0d-a0e9-eaec0d46df9a
using Pipe: @pipe

# ╔═╡ 0f547f22-10b0-4bca-8888-1c24c67c50e9
include("../DynSysAudio.jl")

# ╔═╡ be538c6e-55cf-4b1c-a9db-285a7ff78b04
theme(:dark)

# ╔═╡ dffa2566-3e8e-49fe-b199-922df6013970
begin 
...
# ╔═╡ 7b18d17c-0a4a-4b09-8364-d34002fa5906
soundcard = DynSysAudio.soundcard_init("Scarlett",fs)

# ╔═╡ d2934b8b-07dc-4df8-8086-4d0eadf4964a
...
# ╔═╡ 33e246ad-c64b-4b7a-bac9-1ced58ceeeea
ode_source = DynSysAudio.ODESource(Float64, ghopf!, fs, 0.01, [0.5;0.5],[0.7,1.0,0.02]);

# ╔═╡ d99ede5e-06f2-47f9-8638-3659cba44e97
@bind ticks Clock(0.1,true)

# ╔═╡ 21203ebb-ec77-4cdf-8bd7-38c6c04f9409
md"""
η1 $(@bind η1 Slider(0:0.001:1.0,default=0.85;show_value=true)) 
η2 $(@bind η2 Slider(0:0.001:1.0,default=0.55;show_value=true)) \
...
# ╔═╡ 5e4a62e4-857b-4624-a7a7-03b8cf00f8fd
begin
	restart
	ode_source.gain = 0.0
	sleep(1)
...
# ╔═╡ 6f9a9efb-a010-4924-984f-e20b6b6cae3b
#0.77 0.9-1.0 0.01
#0.8 0.8 0.1

# ╔═╡ 922545b3-387e-477d-99f5-7658befbea23


# ╔═╡ e1879917-e19b-4b13-8cbc-a658a6a97423
begin
	ode_source.gain=g
	ode_source.pars=[η1,η2,γ]
	ode_source.dt=Δt
end;

# ╔═╡ a74e1fee-10f6-4ffb-9f7d-bb5c27e90fc5
begin
	ticks
	sol = solve(ODEProblem(ghopf!,ode_source.uini,(ode_source.time,ode_source.time+tail),[η1,η2,γ]));
end;

# ╔═╡ dcd5297d-8151-452a-9cff-ae0a7012a082
begin
	plot(sol,idxs=(1,2),c=:yellow,size=(1800,1000),ylim=(-5,5),xlim=(-5,5),legend=false)
end	

# ╔═╡ c8e515f3-82ed-45a5-8e1f-71cd71ada5f6
begin
	resetic
	ode_source.uini=[0.1;0.1]
end;

# ╔═╡ e2a68c20-93c0-4ffb-9ab2-d09e69e0b831
html"""
<style>
main {
		margin: 0 auto;
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "1dd4282c5ec560306442ae33c5811a68ea5b0893"
