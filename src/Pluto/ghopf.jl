...
# ╔═╡ f2ff6dea-ddb5-42a0-aca9-75927197ec07
fs=16000

# ╔═╡ f20bdd4d-c32d-4f07-b7ad-a609e0dcb663
soundcard = PortAudioStream(sdev[25],0,2; samplerate=fs)
...
begin
	plot(sol,idxs=(1,2),c=:yellow,size=(2000,1500),ylim=(-5,5),xlim=(-5,5),legend=false)
end	
